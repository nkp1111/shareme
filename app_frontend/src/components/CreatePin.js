      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        <div className="bg-secondaryColor p-3 flex flex-0.7 w-full">
          <div className="flex justify-center item-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            {/* loading during image upload  */}
            {loading && <Spinner />}
            {/* if wrong type of file is uploaded  */}
            {wrongImageType && <p>Wrong image type</p>}
            {/* before and after image uploaded content */}
            {!imageAsset ? (
              // image upload 
              <label>
              ...
              <div className='relative h-full'>
                ...
                {/* delete button to delete uploaded image  */}
                <button
                  type="button"
